...
def feature_extractor(data, n_train, n_test):
    ...
    # Generate features
    pass_length_train = (data_shuffled['password'].str.len().head(n_train).values).T
    ...
    pass_length_test = (data_shuffled['password'].str.len().tail(n_test).values).T

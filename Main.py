...
#Plot.plot_decision_regions(clf2, xtr, ytr, resolution=0.1, title='SVM, Accuracy: ' + str(accuracy_score(yts, clf.predict(xts))))
#Plot.plot_decision_regions(clf3, xtr, ytr, resolution=0.1, title='KDE, Accuracy: ' + str(accuracy_score(yts, clf.predict(xts))))
